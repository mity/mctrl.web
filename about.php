...
<ul>
    ...
    <li><b>Consistency:</b> The controls keep consistent look and feel 
            ...
            visual styles</a>.</li>
    <li><b>Locale neutral:</b> The controls have no built-in strings presented
            to the user, so the library is independent on current locale and
            fits into applications supporting any set of languages and locales.</li>
</ul>
